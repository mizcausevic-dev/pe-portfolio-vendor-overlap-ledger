...
PE Portfolio Vendor Overlap Ledger is a Kinetic Gain benchmark-pack repo for enterprise platform and company signals.
...
`json
{
  "product": "PE Portfolio Vendor Overlap Ledger",
